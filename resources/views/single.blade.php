                            ...
                            <div class="post-additional-info">
                                ...
                                <div class="post__author author vcard">
                                    ...
                                    <div class="post__author-name fn">
                                        <a href="#admin_here" class="post__author-link">{{ $post->user->name }}</a>
                                    </div>
                    ...
                    <div class="blog-details-author">
                        ...
                        <div class="blog-details-author-thumb">
                            <img src="{{ asset($post->user->profile->avatar) }}" alt="Author"
                                 style="border-radius:50%; width:100px; height:110px;"
                            >
                        </div>

                        <div class="blog-details-author-content">
                            <div class="author-info">
                                <h5 id="admin_here" class="author-name">{{ $post->user->name }}</h5>
                            </div>
